<article {{ $attributes->class(['bg-yellow-600 xl:px-32 lg:px-16 2xl:px-48 px-10 py-20']) }} aria-labelledby="recurring-questions">
    <h2 role="heading" aria-level="2" id="recurring-questions"
        class="xl:text-4xl 2xl:text-5xl md:text-3xl text-2xl uppercase font-extrabold font-sans mb-8 xl:mb-20">{{__('recurring.recurring_title')}}</h2>
