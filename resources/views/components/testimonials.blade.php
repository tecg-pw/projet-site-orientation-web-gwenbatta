<article {{ $attributes->class(['bg-yellow-600','xl:px-36','px-10', 'py-20', 'mt-20', 'xl:mt-80']) }}>
    <h3 class="xl:text-4xl text-2xl leading-8 xl:leading-10 uppercase font-extrabold font-sans xl:mb-20 mb-12">{{__('Quelques témoignages de nos alumnis')}}</h3>
