...
<div {{ $attributes }}>
    <form action="{{$urlAction}}" method="GET" class="forms flex flex-col relative">
        ...
        <input class="bg-yellow-100 border border-orange-500 rounded-xl pl-9 pr-2 pb-2 pt-2.5 text-gray-700 leading-tight focus:outline-3 focus:outline-green-700 border focus:bg-orange-100 border border-orange-500 " type="search" name="search" id="search"
