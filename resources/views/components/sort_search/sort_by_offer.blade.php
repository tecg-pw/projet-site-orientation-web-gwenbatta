...
<div {{ $attributes->class(['xl:mb-20 mb-8']) }}>
    ...
    <form action="{{$urlAction}}" method="get" class="forms flex flex-col gap-4">
        <div class="flex justify-between flex-col md:flex-row sm:justify-start xl:justify-start gap-y-4">
            ...
            <div class="flex flex-col md:ml-16">
                ...
                <select class="agency-offer appearance-none rounded-lg bg-green-700 text-white-100 font-sans uppercase font-semibold px-2 py-1 2xl:text-xl"
                        id="agency"
                        name="agency">
                    <option value="all">{{mb_strtoupper(__('sort.all'))}}</option>
