...
<div {{ $attributes->class(['xl:mb-20 mb-8']) }}>
    ...
    <form action="/"
        ...
        <button type="submit"
                class="hover:text-green-700 hover:bg-white-100 border-2 border-green-700 font-sans text-center text-white-100 bg-green-700 py-3 rounded-2xl text-xl font-semibold xl:max-w-[25%] sm:max-w-[75%]">
            {{__('sort.button')}}
        </button>
    </form>
</div>
