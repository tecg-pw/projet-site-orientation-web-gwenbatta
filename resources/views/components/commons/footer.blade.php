<footer class="flex flex-col bg-yellow-100 px-40">
    <div class=" flex justify-between  items-center mt-10">
        ...
        <nav class="border-r-2 border-r-orange-500 border-l-2 border-l-orange-500 px-32" aria-labelledby="navigation">
        ...
        <section aria-labelledby="socials">
            <h2 class="text-green-500 font-medium text-2xl mb-8 font-sans " id="socials" role="heading" aria-level="2">
                {{__('Réseaux sociaux')}}
            </h2>
            <ul >
