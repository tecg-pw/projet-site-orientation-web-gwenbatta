<footer class="flex flex-col bg-yellow-100 xl:px-40">
    <div class="flex-col flex-1 px-10 xl:px-0 xl:flex-row flex justify-between xl:items-center mt-10">
        ...
        <nav class="flex-1 flex-col items-center justify-center flex xl:block border-y-2 border-y-orange-500/40 xl:border-y-0 py-12 xl:py-0 xl:border-r-2 xl:border-r-orange-500/40 xl:border-l-2 xl:border-l-orange-500/40 xl:px-24" aria-labelledby="navigation">
            ...
            <ul class="flex flex-1 justify-between items-center text-xl text-green-500">
                <ul class="mr-14">
                    <li class="hover:text-orange-500 mb-6"><a href="/forum/index">{{__('nav.nav_navigation.forum')}}</a></li>
                    <li class="hover:text-orange-500 mb-6"><a href="/news/index">{{__('nav.nav_navigation.actualities')}}</a></li>
                    <li class="hover:text-orange-500 mb-6"><a href="/bottin">{{__('nav.nav_navigation.people')}}</a></li>
                    <li class="hover:text-orange-500"><a href="/project/index">{{__('nav.nav_navigation.project')}}</a></li>
                </ul>
                <ul>
                    <li class="hover:text-orange-500 mb-6"><a href="/entreprise/internship">{{__('nav.nav_navigation.intership')}}</a></li>
                    <li class="hover:text-orange-500 mb-6"><a href="/bottin/alumni">{{__('nav.nav_navigation.alumni')}}</a></li>
                    <li class="hover:text-orange-500 mb-6"><a href="/contact/student">{{__('nav.nav_navigation.contact')}}</a></li>
                    <li class="hover:text-orange-500"><a href="/technical/tuto">{{__('nav.nav_navigation.tuto')}}</a></li>
                </ul>
            </ul>
        </nav>
        <section class="flex-1 flex-col items-center justify-center flex xl:block py-12 xl:py-0" aria-labelledby="navigation">
            ...
            <ul class="flex flex-1 justify-between items-center xl:items-start xl:ml-16 flex-col text-xl text-green-500">
                    <li class="hover:text-orange-500 mb-6 flex">
                        ...
                        <a href="/">{{__('nav.nav_socials.instagram')}}</a>
                    </li>
                    <li class="hover:text-orange-500 mb-6 flex">
                        ...
                        <a href="/">{{__('nav.nav_socials.facebook')}}</a>
                    </li>
                    <li class="hover:text-orange-500 mb-6 flex">
                        ...
                        <a href="/">{{__('nav.nav_socials.twitter')}}</a></li>
                    <li class="hover:text-orange-500 flex">
                        ...
                        <a href="/">{{__('people.bottin_github')}}</a></li>
            </ul>
        </section>
    </div>
    <div class="px-10 items-center flex-col flex flex-1 justify-between my-14 gap-y-3 xl:flex-row xl:items-start xl:gap-y-0">
        ...
        <a class=" hover:text-orange-500 xl:mr-4" href="/legals">{{__('nav.nav_footer_legals')}}</a>
        <a href="/">{{__('nav.nav_footer_generales')}}</a>
        </div>
    </div>
</footer>
