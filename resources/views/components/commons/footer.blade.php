<footer class="flex flex-col bg-yellow-100 xl:px-40">
    <div class="flex-col flex-1 px-10 xl:px-0 xl:flex-row flex justify-between xl:items-center mt-10">
        ...
        <nav class="flex-1 flex-col items-center justify-center flex xl:block border-y-2 border-y-orange-500/40 xl:border-y-0 py-12 xl:py-0 xl:border-r-2 xl:border-r-orange-500/40 xl:border-l-2 xl:border-l-orange-500/40 xl:px-24" aria-labelledby="navigation">
            <h2 class="text-green-500 font-medium text-2xl text-center mb-8 font-sans " role="heading" aria-level="2" id="navigation">{{__('nav.nav_footer_nav')}}</h2>
            <ul class="flex flex-1 justify-between items-center text-xl text-green-500">
                <ul class="mr-14">
                    <li class="hover:text-orange-500 mb-6"><a href="/{{str_replace('_','-',app()->getLocale())}}/forum/index">{{__('nav.nav_navigation.forum')}}</a></li>
                    <li class="hover:text-orange-500 mb-6"><a href="/{{str_replace('_','-',app()->getLocale())}}/news/index">{{__('nav.nav_navigation.actualities')}}</a></li>
                    <li class="hover:text-orange-500 mb-6"><a href="/{{str_replace('_','-',app()->getLocale())}}/bottin">{{__('nav.nav_navigation.people')}}</a></li>
                    <li class="hover:text-orange-500"><a href="/{{str_replace('_','-',app()->getLocale())}}/project/index">{{__('nav.nav_navigation.project')}}</a></li>
                </ul>
                <ul>
                    <li class="hover:text-orange-500 mb-6"><a href="/{{str_replace('_','-',app()->getLocale())}}/entreprise/internship">{{__('nav.nav_navigation.intership')}}</a></li>
                    <li class="hover:text-orange-500 mb-6"><a href="/{{str_replace('_','-',app()->getLocale())}}/bottin/alumni">{{__('nav.nav_navigation.alumni')}}</a></li>
                    <li class="hover:text-orange-500 mb-6"><a href="/{{str_replace('_','-',app()->getLocale())}}/contact/student">{{__('nav.nav_navigation.contact')}}</a></li>
                    <li class="hover:text-orange-500"><a href="/{{str_replace('_','-',app()->getLocale())}}/technical/tuto">{{__('nav.nav_navigation.tuto')}}</a></li>
                </ul>
            </ul>
        </nav>
        <section class="flex-1 flex-col items-center justify-center flex xl:block py-12 xl:py-0" aria-labelledby="navigation">
            <h2 class="text-green-500 font-medium text-2xl text-center mb-8 font-sans " role="heading" aria-level="2" id="navigation">{{__('nav.nav_footer_socials')}}</h2>
            <ul class="flex flex-1 justify-between items-center xl:items-start xl:ml-16 flex-col text-xl text-green-500">
                    <li class="hover:text-orange-500 mb-6 flex">
                        ...
                        <a href="/{{str_replace('_','-',app()->getLocale())}}">{{__('nav.nav_socials.instagram')}}</a>
                    </li>
                    <li class="hover:text-orange-500 mb-6 flex">
                        ...
                        <a href="/{{str_replace('_','-',app()->getLocale())}}">{{__('nav.nav_socials.facebook')}}</a>
                    </li>
                    <li class="hover:text-orange-500 mb-6 flex">
                        ...
                        <a href="/{{str_replace('_','-',app()->getLocale())}}">{{__('nav.nav_socials.twitter')}}</a></li>
                    <li class="hover:text-orange-500 flex">
                        ...
                        <a href="/{{str_replace('_','-',app()->getLocale())}}">{{__('people.bottin_github')}}</a></li>
            </ul>
        </section>
    </div>
    <div class="px-10 items-center flex-col flex flex-1 justify-between my-14 gap-y-3 xl:flex-row xl:items-start xl:gap-y-0">
        ...
        <a class=" hover:text-orange-500 xl:mr-4" href="/{{str_replace('_','-',app()->getLocale())}}/legals">{{__('nav.nav_footer_legals')}}</a>
        <a href="/{{str_replace('_','-',app()->getLocale())}}">{{__('nav.nav_footer_generales')}}</a>
        </div>
    </div>
</footer>
