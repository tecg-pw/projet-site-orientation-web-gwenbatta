...
@foreach($subjects as $subject)
    <article
            {{ $attributes->class(['slide-in group hover:bg-orange-100  bg-yellow-100 p-2 sm:p-4 relative flex xl:p-6 rounded-xl']) }}
        ...
        <div class="order-2 flex-1 flex flex-col xl:ml-4 justify-center gap-y-2 xl:gap-4">
            <div class="flex flex-col  xl:gap-4">
                <div class="flex gap-2">
                    <h3 class="first-letter:uppercase search-title order-2 font-medium text-lg xl:text-xl 2xl:text-2xl"
                        id="{{$subject->slug}}"
                        role="heading"
