...
<main id="content">
    <article class="xl:px-30 lg:px-16 2xl:px-48 px-10 mb-64" aria-labelledby="projects">
        <div class="flex flex-col md:flex-row justify-between mb-10 mt-14 xl:items-center xl:mt-30 lg:px-16 xl:mb-32">
