            ...
            <div class="mt-12 grid grid-cols-2 gap-x-24 gap-y-8">
                <article class="bg-yellow-100 py-6 px-8 rounded-3xl">
                    <div class="flex justify-between">
                        <div>
                            <h4 class="font-sans font-medium text-2xl mb-2">{{__('Règle Opquast')}}</h4>
                        </div>
                    </div>
                ...
                <article class="bg-yellow-100 py-6 px-8 rounded-3xl">
                    <div class="flex justify-between">
                        <div>
                            <h4 class="font-sans font-medium text-2xl mb-2">{{__('Checklist WCAG')}}</h4>
                        </div>
                    </div>
                ...
                <article class="bg-yellow-100 py-6 px-8 rounded-3xl">
                    <div class="flex justify-between">
                        <div>
                            <h4 class="font-sans font-medium text-2xl mb-2">{{__('GTMetrix')}}</h4>
                        </div>
                    </div>
                ...
                <article class="bg-yellow-100 py-6 px-8 rounded-3xl">
                    <div class="flex justify-between">
                        <div>
                            <h4 class="font-sans font-medium text-2xl mb-2">{{__('HTML Validator')}}</h4>
                        </div>
                    </div>
                ...
                <article class="bg-yellow-100 py-6 px-8 rounded-3xl">
                    <div class="flex justify-between">
                        <div>
                            <h4 class="font-sans font-medium text-2xl mb-2">{{__('CSS Validator')}}</h4>
                        </div>
                    </div>
                ...
                <article class="bg-yellow-100 py-6 px-8 rounded-3xl">
                    <div class="flex justify-between">
                        <div>
                            <h4 class="font-sans font-medium text-2xl mb-2">{{__('CSS Stats')}}</h4>
                        </div>
                    </div>
                ...
                <article class="bg-yellow-100 py-6 px-8 rounded-3xl">
                    <div class="flex justify-between">
                        <div>
                            <h4 class="font-sans font-medium text-2xl mb-2">{{__('Dash')}}</h4>
                        </div>
                    </div>
                ...
                <article class="bg-yellow-100 py-6 px-8 rounded-3xl">
                    <div class="flex justify-between">
                        <div>
                            <h4 class="font-sans font-medium text-2xl mb-2">{{__('Zeel')}}</h4>
                        </div>
                    </div>
                ...
                <article class="bg-yellow-100 py-6 px-8 rounded-3xl">
                    <div class="flex justify-between">
                        <div>
                            <h4 class="font-sans font-medium text-2xl mb-2">{{__('Headings Map')}}</h4>
                        </div>
                    </div>
                ...
                <article class="bg-yellow-100 py-6 px-8 rounded-3xl">
                    <div class="flex justify-between">
                        <div>
                            <h4 class="font-sans font-medium text-2xl mb-2">{{__('Contrats Checker')}}</h4>
                        </div>
                    </div>
                ...
                <article class="bg-yellow-100 py-6 px-8 rounded-3xl">
                    <div class="flex justify-between">
                        <div>
                            <h4 class="font-sans font-medium text-2xl mb-2">{{__('ImagOptim')}}</h4>
                        </div>
                    </div>
                ...
                <article class="bg-yellow-100 py-6 px-8 rounded-3xl">
                    <div class="flex justify-between">
                        <div>
                            <h4 class="font-sans font-medium text-2xl mb-2">{{__('Lighthouse')}}</h4>
                        </div>
                    </div>
