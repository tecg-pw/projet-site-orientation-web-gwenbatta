...
<main id="content">
    <div class="flex items-center xl:px-32 lg:px-16 2xl:px-48 px-10 mt-20">
        ...
        <a href="/{{app()->getLocale()}}/technical/docandtool/tool" class="underline hover:text-orange-500 text-green-500 mt-0.5 text-lg leading-8 xl:leading-10 xl:text-xl 2xl:text-2xl">
    ...
    <section class="xl:px-32 lg:px-16 2xl:px-48 px-10 mt-20 mb-32 xl:mb-64" aria-labelledby="doc-and-tool">
        ...
        <p class="mb-8 text-lg leading-8 xl:max-w-[55%] xl:text-xl xl:leading-10 2xl:text-2xl 2xl:leading-12">{{__('docandtool.doc_tool_text')}}</p>
        <article aria-labelledby="list-tools">
            ...
            <div class="flex flex-col md:flex-row justify-between md:justify-start md:gap-x-10 xl:justify-start mb-12">
                <a class="text-xl 2xl:text-2xl underline text-green-700 font-semibold font-sans xl:mr-36 px-5 py-2" href="/{{app()->getLocale()}}/technical/docandtool/doc">{{__('docandtool.doc_link')}}</a>
                <a class="rounded-lg text-xl 2xl:text-2xl underline text-green-700 font-semibold font-sans bg-orange-100 px-5 py-2" href="/{{app()->getLocale()}}/technical/docandtool/tool">{{__('docandtool.tool_link')}}</a>
            </div>
