    ...
    <section class="px-36 mt-20 mb-64" aria-labelledby="doc-and-tool">
        ...
        <article aria-labelledby="list-tools">
            ...
            <div class="flex mb-12">
                ...
                <a class="rounded-lg text-xl underline text-green-700 font-semibold font-sans bg-orange-100 px-5 py-2" href="/technical/docandtool/tool">{{__('Outils')}}</a>
            </div>
            <div class="mt-12 grid grid-cols-2 gap-x-24 gap-y-8">
                <article class="hover:bg-orange-100 relative group bg-yellow-100 py-6 px-8 rounded-3xl" aria-labelledby="opquast">
                    <div class="flex justify-between">
                        <div>
                            <h4 id="opquast" role="heading" aria-level="4" class="font-medium text-2xl mb-2">{{__('Règle Opquast')}}</h4>
                        </div>
                    </div>
                ...
                <article class="hover:bg-orange-100 relative group bg-yellow-100 py-6 px-8 rounded-3xl" aria-labelledby="wcag">
                    <div class="flex justify-between">
                        <div>
                            <h4 id="wcag" role="heading" aria-level="4" class="font-medium text-2xl mb-2">{{__('Checklist WCAG')}}</h4>
                        </div>
                    </div>
                ...
                <article class="hover:bg-orange-100 relative group bg-yellow-100 py-6 px-8 rounded-3xl" aria-labelledby="gtmetrix">
                    <div class="flex justify-between">
                        <div>
                            <h4 id="gtmetrix" role="heading" aria-level="4" class="font-medium text-2xl mb-2">{{__('GTMetrix')}}</h4>
                        </div>
                    </div>
                ...
                <article class="hover:bg-orange-100 relative group bg-yellow-100 py-6 px-8 rounded-3xl" aria-labelledby="html-validator">
                    <div class="flex justify-between">
                        <div>
                            <h4 id="html-validator" role="heading" aria-level="4" class="font-medium text-2xl mb-2">{{__('HTML Validator')}}</h4>
                        </div>
                    </div>
                ...
                <article class="hover:bg-orange-100 relative group bg-yellow-100 py-6 px-8 rounded-3xl" aria-labelledby="css-validator">
                    <div class="flex justify-between">
                        <div>
                            <h4 id="css-validator" role="heading" aria-level="4" class="font-medium text-2xl mb-2">{{__('CSS Validator')}}</h4>
                        </div>
                    </div>
                ...
                <article class="hover:bg-orange-100 relative group bg-yellow-100 py-6 px-8 rounded-3xl" aria-labelledby="css-stats">
                    <div class="flex justify-between">
                        <div>
                            <h4 id="css-stats" role="heading" aria-level="4" class="font-medium text-2xl mb-2">{{__('CSS Stats')}}</h4>
                        </div>
                    </div>
                ...
                <article class="hover:bg-orange-100 relative group bg-yellow-100 py-6 px-8 rounded-3xl" aria-labelledby="dash">
                    <div class="flex justify-between">
                        <div>
                            <h4 id="dash" role="heading" aria-level="4" class="font-medium text-2xl mb-2">{{__('Dash')}}</h4>
                        </div>
                    </div>
                ...
                <article class="hover:bg-orange-100 relative group bg-yellow-100 py-6 px-8 rounded-3xl" aria-labelledby="zeel">
                    <div class="flex justify-between">
                        <div>
                            <h4 id="zeel" role="heading" aria-level="4" class="font-medium text-2xl mb-2">{{__('Zeel')}}</h4>
                        </div>
                    </div>
                ...
                <article class="hover:bg-orange-100 relative group bg-yellow-100 py-6 px-8 rounded-3xl" aria-labelledby="headings-map">
                    <div class="flex justify-between">
                        <div>
                            <h4 id="headings-map" role="heading" aria-level="4" class="font-medium text-2xl mb-2">{{__('Headings Map')}}</h4>
                        </div>
                    </div>
                ...
                <article class="hover:bg-orange-100 relative group bg-yellow-100 py-6 px-8 rounded-3xl" aria-labelledby="contrast-checker">
                    <div class="flex justify-between">
                        <div>
                            <h4 id="contrast-checker" role="heading" aria-level="4" class="font-medium text-2xl mb-2">{{__('Contrast Checker')}}</h4>
                        </div>
                    </div>
                ...
                <article class="hover:bg-orange-100 relative group bg-yellow-100 py-6 px-8 rounded-3xl" aria-labelledby="imagoptim">
                    <div class="flex justify-between">
                        <div>
                            <h4 id="imagoptim" role="heading" aria-level="4" class="font-medium text-2xl mb-2">{{__('ImagOptim')}}</h4>
                        </div>
                    </div>
                ...
                <article class="hover:bg-orange-100 relative group bg-yellow-100 py-6 px-8 rounded-3xl" aria-labelledby="lighthouse">
                    <div class="flex justify-between">
                        <div>
                            <h4 id="lighthouse" role="heading" aria-level="4" class="font-medium text-2xl mb-2">{{__('Lighthouse')}}</h4>
                        </div>
                    </div>
