...
<main id="content">
    <div class="xl:px-32 lg:px-16 2xl:px-48 px-10 flex items-center mt-20">
    ...
    <section class="xl:px-32 lg:px-16 2xl:px-48 px-10 mt-20 mb-32 xl:mb-64" aria-labelledby="tutos">
