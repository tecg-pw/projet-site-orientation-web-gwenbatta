...
<main id="content">
    <div class="flex items-center flex-wrap xl:px-36 2xl:px-48 px-10 mt-20">
            ...
            <div class="mb-7 col-span-5 max-w-full 4xl:mt-32">
                <section aria-labelledby="description">
                    ...
                    <div class="flex flex-col gap-6">
                        <div class="wysiwyg slide-in text-lg leading-8 xl:leading-10 xl:text-xl 2xl:text-2xl 2xl:leading-12">{!!$book->description!!}</div>
                    </div>
                    <div class="mt-8">
