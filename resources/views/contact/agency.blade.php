    ...
    <section class="mt-20 mb-36 flex justify-center" aria-labelledby="contact">
        <div class="px-36">
            ...
            <div class="flex flex-1">
                <a class="hover:text-orange-500 font-sans text-green-700 text-xl rounded-lg font-semibold underline mr-28 py-2.5 px-6"
                   href="/contact/student">{{__('Étudiants')}}</a>
                <a class="bg-orange-200  rounded-lg font-sans text-green-700 self-center text-xl font-semibold underline flex-1 py-2.5 px-6"
            ...
            <div class="flex  mt-14">
                <form action="/" method="post" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <div class="flex mt-2">
                            <fieldset class="pr-12 border-r border-orange-500 mr-12">
                                <span class="text-green-500 text-xl ">{{__('Langage de programmation')}}</span><br>
                            ...
                            <fieldset>
                                <span class="text-green-500 text-xl">{{__('Maîtrise des logiciels')}}</span><br>
                    ...
                    <div class="flex flex-1 justify-end">
                        <input class="hover:text-green-700 hover:bg-white-100 border-2 border-green-700 font-sans text-center text-white-100 bg-green-700 px-16 py-3 rounded-2xl text-xl font-semibold"
