        ...
        <div class="xl:px-32 2xl:pl-48 mt-10 flex-1 lg:col-span-4">
            ...
            @if(session('success'))
                <div class="mt-12 mb-4 bg-orange-200 rounded-lg flex items-center gap-x-2 px-4 py-2.5">
                    ...
                    <p class="mt-1 text-green-700 text-xl xl:text-2xl 2xl:text-3xl">{{session('success')}}</p>
                </div>
            @else
                ...
                <form action="/{{app()->getLocale()}}/contact/student" method="post" class="flex-1 px-10 xl:px-0">
                    ...
                    <div class="slide-in flex flex-col xl:flex-row flex-1">
                        <div class="flex flex-col flex-1 xl:mr-10 mb-8">
                            <label class="text-green-500 text-lg xl:text-2xl 2xl:text-3xl " for="name">{{__('contact_page.student_name')}}</label>
                            @error('name')
                        ...
                        <div class="flex flex-col flex-1 mb-8">
                            <label class="text-green-500 text-lg xl:text-2xl 2xl:text-3xl" for="firstname">{{__('contact_page.student_firstname')}}</label>
                            @error('firstname')
                            <div class="flex gap-1.5 items-center">
                                <svg class="h-7 w-7 text-red-500"  fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                    ...
                    <div class="slide-in flex flex-col mb-8">
                        <label class="text-green-500 text-lg xl:text-2xl 2xl:text-3xl" for="email">{{__('contact_page.mail')}}</label>
                        @error('email')
                        <div class="flex gap-1.5 items-center">
                            <svg class="h-7 w-7 text-red-500"  fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                    ...
                    <div class="slide-in flex flex-col mb-8">
                        <label class="text-green-500 text-lg xl:text-2xl 2xl:text-3xl" for="subject">{{__('contact_page.student_object')}}</label>
                        @error('subject')
                        <div class="flex gap-1.5 items-center">
                            <svg class="h-7 w-7 text-red-500"  fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                    ...
                    <div class="slide-in flex flex-col mb-8">
                        <label class="text-green-500 text-lg xl:text-2xl 2xl:text-3xl" for="message">{{__('contact_page.student_message')}}</label>
                        @error('message')
                        <div class="flex gap-1.5 items-center">
                            <svg class="h-7 w-7 text-red-500"  fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        ...
                        @enderror
                        <x-forms.tinymce-editor :name="'message'" :placeholder="'contact_page.student_message_value'">{{old('message')}}</x-forms.tinymce-editor>
                    </div>
