    ...
    <section class="mt-20 flex justify-center" aria-labelledby="contact">
        <div class="px-36">
            ...
            <div class="flex flex-1">
                <a class="bg-orange-200 font-sans text-green-700 text-xl rounded-lg font-semibold underline mr-28 py-2.5 px-6"
                   href="/contact/student">{{__('Étudiants')}}</a>
                <a class="hover:text-orange-500  font-sans text-green-700 self-center text-xl font-semibold underline flex-1 py-2.5 px-6"
