...
<main id="content" class="">
    <section class="mt-20" aria-labelledby="alumni">
        <div class="px-10 flex flex-col xl:px-30 lg:px-16 2xl:px-48 xl:flex-row justify-between mb-7 xl:items-center">
        ...
        <p class="px-10 xl:pl-30 lg:px-16 2xl:pl-48 mb-7 xl:max-w-[47%] xl:text-xl xl:leading-10">{{__('people.alumni_text')}}</p>
        <x-sort_by :status="$status" :years_end="$years_end"/>
        <article class="px-10 flex flex-col gap-y-4 xl:px-30 lg:px-16 2xl:px-48 lg:grid lg:grid-cols-2 xl:gap-x-24 lg:gap-x-12 xl:gap-y-8"
