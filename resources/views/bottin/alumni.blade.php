...
<main id="content">
    <section class="mt-20" aria-labelledby="alumni">
        <div class="px-10 flex flex-col xl:px-32 lg:px-16 2xl:px-48 md:flex-row justify-between mb-7 xl:items-center">
        ...
        <x-sort_search.sort_by_people class="mb-14" id="alumni_sort" :urlAction="$urlAction" :status="$status" :years_end="$years_end"/>
