<x-commons.navigation :page="$student->firstname.' '.$student->name"></x-commons.navigation>
<main id="content">
    ...
    <section class="mt-20 px-10 2xl:px-48 xl:px-32 lg:px-16 flex flex-col mb-20 xl:mb-36 gap-x-11" aria-labelledby="name">
        ...
        <div class="flex flex-col md:flex-row gap-6 xl:gap-12 mt-16">
            <div class="xl:mt-4 mb-8 order-2">
                    ...
                    <div>
                        ...
                        <div class="flex flex-1 mb-6 gap-5">
                            <div class="relative group">
                                ...
                                <a class="linkcard" href="{{$student->link_github}}"></a>
                            </div>
                            <div class="group relative">
                                ...
                                <a class="linkcard" href="{{$student->instagram}}"></a>
                            </div>
                            <div class="group relative">
                                <svg class="group-hover:scale-110" xmlns="http://www.w3.org/2000/svg" width="30"
                                ...
                                <a class="linkcard" href="{{$student->linkedin}}"></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                @else
                    <div class="wysiwyg flex flex-col gap-6 text-lg leading-8 2xl:text-2xl 2xl:leading-12 xl:text-xl xl:leading-10 xl:max-w-[80%]">
                        {!!$student->description!!}
                    </div>
                @endif
            </div>
