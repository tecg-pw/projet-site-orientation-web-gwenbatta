...
<main id="content">
    ...
    <section class="mt-20 px-10 2xl:px-48 xl:px-32 lg:px-16 flex flex-col mb-20 xl:mb-36 gap-x-11"
        ...
        <div class="flex flex-col md:flex-row gap-6 xl:gap-12 mt-16">
            <div class="mt-4 mb-7 order-2">
                    ...
                    <div>
                        ...
                        <div class="flex gap-y-1.5 flex-col xl:gap-y-2.5 mb-5 text-lg xl:text-xl 2xl:text-2xl">
                            ...
                            <a class="hover:text-orange-500 text-green-700 underline text-xl"
                               href="{{__($alumni->link_portfolio)}}">{{__($alumni->link_portfolio)}}</a>
                        </div>
                        <div class="flex flex-1 mb-6 gap-5">
                            <div class="relative group">
                                ...
                                <a class="linkcard" href="{{$alumni->link_github}}"></a>
                            </div>
                            <div class="group relative">
                                ...
                                <a class="linkcard" href="{{$alumni->instagram}}"></a>
                            </div>
                            <div class="group relative">
                                <svg class="group-hover:scale-110" xmlns="http://www.w3.org/2000/svg" width="30"
                                ...
                                <a class="linkcard" href="{{$alumni->linkedin}}"></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                @else
                    <div class="wysiwyg flex flex-col gap-6 text-lg leading-8 xl:text-xl 2xl:text-2xl 2xl:leading-12 xl:leading-10 xl:max-w-[65%]">
                        {!! $alumni->description !!}
                    </div>
                @endif
            </div>
