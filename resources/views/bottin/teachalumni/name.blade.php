<x-commons.navigation :page="$teachalumni->firstname.' '.$teachalumni->name"></x-commons.navigation><main id="content" class="">
    <div class="flex items-center px-10 2xl:px-48 xl:px-32 lg:px-16 mt-20">
        ...
        <a href="/{{app()->getLocale()}}/bottin/teachalumni/{{$teachalumni->slug}}" class="underline hover:text-orange-500 text-green-500 mt-0.5 text-lg leading-8 xl:leading-10 xl:text-xl">
    ...
    <section class="mt-20 px-10 2xl:px-48 xl:px-32 lg:px-16 flex flex-col mb-20 xl:mb-36 gap-x-11" aria-labelledby="name">
        <div class=" flex flex-col justify-between text-green-700 font-sans font-semibold md:flex-row">
            <h2 id="name" role="heading" aria-level="2"
                class="xl:text-4xl md:text-3xl text-2xl uppercase font-extrabold text-yellow-800 font-sans">{{$teachalumni->firstname}} {{$teachalumni->name}}</h2>
        ...
        <div class="flex flex-col md:flex-row gap-6 xl:gap-12 mt-16">
            <div class="mt-4 mb-7 order-2">
                <div class="flex gap-12">
                    <div>
                        <div class="mb-4 flex gap-8 md:flex-col md:gap-y-2 xl:flex-row xl:justify-between uppercase text-lg xl:text-xl">
    ...
    <article class="bg-yellow-600 2xl:px-48 xl:px-32 lg:px-16 px-10 pb-24 pt-20" aria-labelledby="classes">
        <div class="flex xl:flex-row flex-col justify-between mb-8">
            <h2 id="classes" role="heading" aria-level="2" class="xl:text-4xl md:text-3xl text-2xl uppercase font-extrabold font-sans mb-4 xl:mb-20">{{__('people.bottin_course') . ( $teachalumni->firstname . ' ' .$teachalumni->name)}}</h2>
    ...
    <article class="px-10 2xl:px-48 xl:px-32 lg:px-16 pb-40 pt-20" aria-labelledby="projects">
        <div class="justify-between flex flex-col mb-8 md:flex-row">
            <h2 id="projects" role="heading" aria-level="2"
                class="xl:text-4xl text-yellow-800 md:text-3xl text-2xl uppercase font-extrabold font-sans mb-4 xl:mb-20">{{__('project.project_other')}}</h2>
