    ...
    <section class="px-36 flex mt-14 mb-36 gap-24 items-center" aria-labelledby="intro">
        <div class="flex-1 ">
            ...
            <div class="mt-20 flex items-center justify-between">
                <a href="/about"
                   class="hover:text-green-700 hover:bg-white-100 border-2 border-green-700 font-sans text-center text-white-100 bg-green-700 px-10 py-3 rounded-2xl text-2xl font-semibold ">{{__('En savoir plus')}}</a>
        ...
        <div class="flex-1 ">
            ...
            <div class="mt-20 flex items-center justify-between">
                <a href="/contact/student"
                   class="hover:text-green-700 hover:bg-white-100 border-2 border-green-700 font-sans text-center text-white-100 bg-green-700 px-10 py-3 rounded-2xl text-2xl font-semibold ">{{__('Contactez-nous')}}</a>
                <a class="hover:text-orange-500 self-center flex font-sans text-end text-green-700 text-2xl font-semibold underline px-4 py-6 self-end"
