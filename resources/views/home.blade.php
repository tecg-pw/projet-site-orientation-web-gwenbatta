...
<main class="text-2xl">
    ...
    <section class="mt-40 bg-yellow-600 px-36 grid grid-cols-5 pb-28 gap-20" aria-labelledby="why">
        ...
        <div class="self-center col-span-2 mt-16">
            <div class="flex flex-col pt-7 justify-self-center pb-8 border-b-2 border-orange-500">
                <p class="text-3xl font-sans font-light text-green-700 underline decoration-dashed mb-6">{{__('Des cours de qualité')}}</p>
                <p class="leading-9">{{__('L’option web a un excellent cursus d’apprentissage, les entreprises raffolent de nos étudiants.')}}</p>
                <svg class="self-end mr-4" xmlns="http://www.w3.org/2000/svg" width="32" height="27.417"
            ...
            <div class="flex flex-col pt-7 justify-self-center pb-8 border-b-2 border-orange-500">
                <p class="text-3xl font-sans font-light text-green-700 underline decoration-dashed mb-6">{{__('Une sûreté d\'emploi')}}</p>
                <p class="leading-9">{{__('De nombreuses entreprises viennent recruter nos élèves dès leur sortie de l’école.')}}</p>
                <svg class="self-end mr-4" xmlns="http://www.w3.org/2000/svg" width="32" height="27.417"
                     viewBox="0 0 32 27.417">
                    <path d="M51,21.715a1.956,1.956,0,0,1-.56,1.355l-.012.023-11.75,11.75a1.958,1.958,0,1,1-2.769-2.769l8.405-8.409H20.958a1.958,1.958,0,0,1,0-3.917H44.314l-8.405-8.405a1.958,1.958,0,1,1,2.769-2.769l11.75,11.75.012.02A1.968,1.968,0,0,1,51,21.707Z"
                        transform="translate(-19 -8.001)" fill="#4e6458"/>
            ...
            <div class="flex flex-col pt-7 justify-self-center pb-12 ">
                <p class="text-3xl font-sans font-light text-green-700 underline decoration-dashed mb-6">{{__('Des professeurs passionnés')}}</p>
                <p class="leading-9">{{__('Nos professeurs sont de vrais passionnés et ils prennent le temps de nous transmettre leur passion.')}}</p>
                <svg class="self-end mr-4" xmlns="http://www.w3.org/2000/svg" width="32" height="27.417"
                     viewBox="0 0 32 27.417">
                    <path d="M51,21.715a1.956,1.956,0,0,1-.56,1.355l-.012.023-11.75,11.75a1.958,1.958,0,1,1-2.769-2.769l8.405-8.409H20.958a1.958,1.958,0,0,1,0-3.917H44.314l-8.405-8.405a1.958,1.958,0,1,1,2.769-2.769l11.75,11.75.012.02A1.968,1.968,0,0,1,51,21.707Z"
                        transform="translate(-19 -8.001)" fill="#4e6458"/>
                ...
                @for($i=1;$i<6;$i++)
                    <article class="bg-white-100 flex p-6 rounded-xl" aria-labelledby="{{'question'.$i}}">
                        <div class="order-2 flex-1 flex flex-col ml-4">
                            <h3 class="order-2 font-medium font-sans text-2xl mb-4" id="{{'question'.$i}}"
                                role="heading"
            ...
            <div class="col-span-2 flex flex-col gap-y-6 pl-14">
                    ...
                    <div class="flex flex-col gap-y-8">
                        @for($i=1;$i<3;$i++)
                            <article class="bg-white-100 flex p-6 rounded-xl"
                                     aria-labelledby="{{'question-latest'.$i}}">
                                <div class="order-2 flex-1 flex flex-col ml-4">
                                    <h4 class="order-2 font-medium font-sans text-2xl mb-4"
                                        id="{{'question-latest'.$i}}" role="heading"
                ...
                <article class="flex flex-col gap-y-8 " aria-labelledby="best-rating">
                    ...
                    <div class="flex flex-col gap-y-8">
                        @for($i=1;$i<3;$i++)
                            <article class="bg-white-100 flex p-6 rounded-xl"
                                     aria-labelledby="{{'question-rating'.$i}}">
                                <div class="order-2 flex-1 flex flex-col ml-4">
                                    <h4 class="order-2 font-medium font-sans text-2xl mb-4"
                                        id="{{'question-rating'.$i}}" role="heading"
                                        aria-level="3">Question du forum</h4>
                                    <div class="flex justify-between">
                                        <p class="text-xl mb-2">Nom de l'auteur</p>
                                        <p>03 novembre 2022</p>
