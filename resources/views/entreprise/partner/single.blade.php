    ...
    <section class="mt-20 px-36 flex mb-36 gap-x-11" aria-labelledby="name">
        <div class="mb-7 order-2">
            ...
            <p class="flex flex-col gap-6 text-lg leading-10 max-w-[65%]">
                ...
                <span>{{__('La satisfaction du client est au centre de nos préoccupations. Chez LWS pas besoin de publicité, c’est le bouche-à-oreille réalisé par nos 300 clients répartis aux quatre coins de Wallonie & Bruxelles qui nous fait connaître.»')}}</span>
            </p>
                ...
                <article class="relative bg-white-100 py-6 px-8 rounded-3xl" aria-labelledby="slug">
                    ...
                    <div class="flex justify-between">
                        <a class="order-3 underline text-green-700 font-sans font-semibold self-end"
                           href="/entreprise/partner/single">Nom de l'agence</a>
                    </div>
                    <a class="linkcard order-3 underline text-green-700 font-sans font-semibold self-end"
