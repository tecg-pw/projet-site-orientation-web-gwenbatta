...
<main id="content">
    <div class="flex flex justify-between flex-col md:flex-row sm:justify-start xl:justify-start gap-y-4 items-center px-10 xl:px-32 lg:px-16 2xl:px-48 mt-20">
