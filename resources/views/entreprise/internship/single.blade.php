            ...
            <div class="flex flex-col gap-16">
                <article class="even:mt-36 relative mt-48">
                    ...
                    <div class="relative bg-yellow-100 rounded-xl px-4 py-8 left-10">
                        ...
                        <a class="underline text-green-700 text-xl" href="mailto:">info@lws.be</a>
                ...
                <div class="flex flex-col gap-5">
                    <a href="/"
                       class="font-sans text-center text-white-100 bg-green-700 px-4 py-4 rounded-2xl text-2xl font-semibold ">{{__('Voir le site')}}</a>
