    ...
    <section class="xl:px-36 px-10 mt-20 mb-20 xl:mb-40" aria-labelledby="{{$offer->slug}}">
        ...
        <div class="flex xl:flex-row flex-col">
            <div class="flex flex-col gap-16">
                <article class="even:mt-36 relative mt-48" aria-labelledby="{{$partner->slug}}">
                    <img class="rounded-lg absolute -z-10 bottom-2/3" src="{{$partner->logo}}"
                         alt="avatar">
                    <div class="relative bg-yellow-100 rounded-xl px-4 py-8 left-10">
                        <h3 id="{{$partner->slug}}" role="heading" aria-level="3" class="underline font-medium text-xl xl:text-2xl mb-2">
                            <a class="text-green-700 hover:text-orange-500" href="/{{str_replace('_','-',app()->getLocale())}}/entreprise/partner/{{$partner->slug}}">
                                {{$partner->name}}
                            </a>
                        </h3>
                        <div>
                            <p class="xl:text-lg">{{$partner->adresse}},</p>
                            <p class="mb-4 xl:text-lg">{{$partner->locality_number}} {{$partner->locality}}</p>
                        </div>
                        <a class="hover:text-orange-500 underline text-green-700 text-lg xl:text-xl" href="mailto:{{$partner->mail}}">{{$partner->mail}}</a>
