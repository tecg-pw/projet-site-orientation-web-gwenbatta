    ...
    <section class="px-36 mt-20" aria-labelledby="company">
        <div class="flex justify-between mb-24 items-center">
            <h2 id="company" role="heading" aria-level="2"
                class="text-4xl uppercase font-extrabold text-yellow-800 font-sans text-center">{{__('Les entreprises')}}</h2>
        ...
        <div class="flex gap-20 mb-12">
            ...
            <a class="text-xl rounded-lg underline text-green-700 font-semibold bg-orange-100 font-sans px-5 py-2"
