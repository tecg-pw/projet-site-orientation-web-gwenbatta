...
<main id="content">
    <section class="px-10 lg:px-16 xl:px-32 2xl:px-48 py-20 items-center xl:gap-24 flex lg:grid lg:grid-cols-5  justify-center"
             aria-labelledby="login">
        <div class="lg:col-span-3 px-10">
            <div class="flex flex-col">
                <h2 class="text-2xl 2xl:text-5xl md:text-3xl xl:text-4xl uppercase font-bold text-yellow-800 xl:mb-7 mb-3 font-sans order-1 mt-6"
                    role="heading" aria-level="2" id="login">
                    {{__('Réinitialisation du mot de passe')}}
                </h2>
            </div>
            <div class="flex mt-14">
                <form action="/{{app()->getLocale()}}/user/reset-password" method="post" class="flex flex-col xl:block min-w-full">
                    @csrf
