...
<main>
    ...
    <article class="bg-yellow-600 px-36 pb-36 pt-20">
        <h2 class="text-4xl uppercase font-extrabold font-sans mb-20">{{__('Tutos Favoris')}}</h2>
    ...
    <section class="px-36 mt-36 mb-36">
        <h2 class="text-4xl text-yellow-800 uppercase font-extrabold font-sans mb-20">{{__('Vos questions')}}</h2>
