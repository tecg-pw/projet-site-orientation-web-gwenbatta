        ...
        <div class="flex">
            <article class="relative mt-48" aria-labelledby="slug-auteur">
                ...
                <div class="relative bg-yellow-100 rounded-xl px-4 py-8 left-10">
                    ...
                    <a class="underline text-green-700 text-xl" href="/">gwenaelle-batta.be</a>
            ...
            <div class="ml-28">
                ...
                <div class="mt-8">
                    <div class="flex gap-4 text-lg">
                        ...
                        <a class="underline text-green-700 font-sans" href="/cours/single">{{__('Cours')}}</a>
                    </div>
                    <div class="flex gap-4 text-lg">
                        <p>{{__('Avec :')}}</p>
                        <a class="underline text-green-700 font-sans"
                    ...
                    <div class="mt-20 flex items-center gap-32">
                        <a href="/"
                           class="font-sans text-center text-white-100 bg-green-700 px-10 py-3 rounded-2xl text-2xl font-semibold ">{{__('Voir le portfolio')}}</a>
