...
<main class="flex min-h-full gap-x-20 mb-60">
        <section class="min-w-full mt-20 px-36 flex flex-col items-center justify-center" aria-labelledby="404">
            ...
            <p class="text-2xl">{{__('Page non trouvée')}}</p>
            <p class="text-xl mt-2">{{__('Retourner à')}} <a class="hover:text-orange-500 text-green-700 underline" href="/">{{__('l\'acceuil')}}</a> </p>
        </section>
</main>
