...
<main id="content">
    <section aria-labelledby="slug">
        <div class="flex md:flex-row flex-col 2xl:px-48 xl:px-30 lg:px-16 px-10 justify-between mt-20 mb-8">
        ...
        <div class="xl:px-30 lg:px-16 2xl:px-48 mb-6 xl:mb-0 px-10 flex justify-between sm:justify-start sm:gap-x-10  xl:justify-start xl:gap-20 text-lg xl:text-xl">
        ...
        <div class="xl:px-30 lg:px-16 2xl:px-48 xl:mt-6 px-10 lg:grid lg:grid-cols-10 items-end mb-36 gap-x-10 xl:gap-x-20">
    ...
    <article class="bg-yellow-600 2xl:px-48 px-10 xl:px-30 lg:px-16 pb-40 pt-20" aria-labelledby="projects">
