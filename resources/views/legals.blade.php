...
<main id="content" class="flex flex-col lg:flex-row gap-x-20 mb-60">
    ...
    <div class="">
        ...
        <section class="mt-20 px-10 xl:pr-30" aria-labelledby="cookies">
            ...
            <p class="text-lg leading-8 xl:text-xl 2xl:text-2xl 2xl:leading-12 mb-6">{{__('legals.cookies_text_part_1')}}</p>
            <p class="text-lg leading-8 xl:text-xl 2xl:text-2xl 2xl:leading-12 mb-6">{{__('legals.cookies_text_part_2')}}</p>
            <p class="text-lg leading-8 xl:text-xl 2xl:text-2xl 2xl:leading-12 mb-6">{{__('legals.cookies_text_part_3')}}</p>
            <p class="text-lg leading-8 xl:text-xl 2xl:text-2xl 2xl:leading-12 mb-6">{{__('legals.cookies_text_part_4')}}</p>
