...
<main class="flex gap-x-20 mb-60">
        <section class="bg-yellow-600 mt-20 py-20 px-36" aria-labelledby="informations">
            <h2 class="text-4xl uppercase font-extrabold font-sans mb-11" role="heading" aria-level="2"
                id="informations">{{__('Informations générales')}}</h2>
            <section class="mb-14 " aria-labelledby="company" itemscope itemtype="https://schema.org/Organization">
                <h3 class="text-2xl font-semibold" role="heading" aria-level="3" id="company">{{__('Société')}}</h3>
                <p class="text-xl" itemprop="streetAddress">{{__('Haute école de la province de Liège')}}</p>
            </section>
            <section class="mb-14 " aria-labelledby="social">
                <h3 class="text-2xl  font-semibold" role="heading" aria-level="3" id="social">{{__('Siège social')}}</h3>
                <div itemscope itemtype="https://schema.org/PostalAddress">
                    <p class="text-xl" itemprop="streetAddress">{{('Rue Peetermans, 80')}}</p>
                    <p class="text-xl" itemprop="postalCode">{{__('4100, Seraing')}}</p>
                </div>
            </section>
            <section class="mb-14 " aria-labelledby="email" itemscope itemtype="https://schema.org/Organization">
                <h3 class="text-2xl  font-semibold" role="heading" aria-level="3" id="email">{{__('Email')}}</h3>
                <p class="text-xl" itemprop="email">{{__('tech.secretariat@hepl.be')}}</p>
            </section>
        </section>
    <div class="">
        <section class="mt-20 pr-36" aria-labelledby="confidential">
