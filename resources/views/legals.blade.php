...
<main>
    <section aria-labelledby="informations">
        <h2 role="heading" aria-level="2" id="informations">{{__('Informations générales')}}</h2>
        <section aria-labelledby="company" itemscope itemtype="https://schema.org/Organization">
            <h3 role="heading" aria-level="3" id="company">{{__('Société')}}</h3>
            <p itemprop="streetAddress">{{__('Haute école de la province de Liège')}}</p>
        </section>
        <section aria-labelledby="social">
            <h3 role="heading" aria-level="3" id="social">{{__('Siège social')}}</h3>
            <div itemscope itemtype="https://schema.org/PostalAddress">
                <p itemprop="streetAddress">{{('Rue Peetermans, 80')}}</p>
                <p itemprop="postalCode">{{__('4100, Seraing')}}</p>
            </div>
        </section>
        <section aria-labelledby="email" itemscope itemtype="https://schema.org/Organization">
            <h3 role="heading" aria-level="3" id="email">{{__('Email')}}</h3>
            <p itemprop="email">{{__('tech.secretariat@hepl.be')}}</p>
        </section>
    </section>
    <section aria-labelledby="confidential">
        <h2 role="heading" aria-level="2" id="confidential">{{__('Clauses de confidentialités')}}</h2>
    ...
    <section aria-labelledby="cookies">
        <h2 role="heading" aria-level="2" id="cookies">{{__('Utilisations de cookies')}}</h2>
