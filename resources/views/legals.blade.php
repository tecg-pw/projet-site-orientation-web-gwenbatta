...
<main class="flex gap-x-20 mb-60">
        <section class="bg-yellow-600 mt-20 py-20 px-36" aria-labelledby="informations">
            ...
            <section class="mb-14 " aria-labelledby="company" itemscope itemtype="https://schema.org/Organization">
                <h3 class="font-sans text-lg font-semibold" role="heading" aria-level="3" id="company">{{__('Société')}}</h3>
                <p itemprop="streetAddress">{{__('Haute école de la province de Liège')}}</p>
            </section>
            <section class="mb-14 " aria-labelledby="social">
                <h3 class="font-sans text-lg font-semibold" role="heading" aria-level="3" id="social">{{__('Siège social')}}</h3>
            ...
            <section class="mb-14 " aria-labelledby="email" itemscope itemtype="https://schema.org/Organization">
                <h3 class="font-sans text-lg font-semibold" role="heading" aria-level="3" id="email">{{__('Email')}}</h3>
