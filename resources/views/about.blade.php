...
<main>
    ...
    <section class="px-10 xl:px-36 mt-14 mb-36 gap-24 items-center" aria-labelledby="profs">
        ...
        <div class="xl:grid xl:grid-cols-2 flex flex-col mt-60 gap-y-60 xl:mt-36 xl:gap-y-40 xl:gap-x-60">
            @for($i=1; $i<7; $i++)
                <article class=" even:mt-36 relative" aria-labelledby="slug">
                    ...
                    <div class="relative bg-yellow-100 rounded-xl px-4 py-8 left-10">
                        <h3 class="font-medium text-2xl mb-5" id="slug" aria-level="3" role="heading">
                            <a class="hover:text-orange-500" href="/bottin/teacher/name">Nom du professeur</a>
                        </h3>
                        <a class="hover:text-orange-500 text-xl underline text-green-700" href="mailto:@hepl.be">adresse
                            mail</a>
                        <div class="flex gap-60 items-center mt-4 ">
                            <div class="flex gap-3">
                                <div class="relative group">
                                    ...
                                    <a class="linkcard" href="https://www.linkedin.com/in/dominiquevilain/">Aller sur le
                                        réseaux</a>
                                </div>
                                <div class="relative group">
                                    <svg class="group-hover:scale-110" xmlns="http://www.w3.org/2000/svg" width="25"
