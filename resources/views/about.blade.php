...
<main>
    ...
    <section  class="bg-yellow-600 mt-20 py-20 px-36" aria-labelledby="course" >
        ...
        <div class="flex justify-between">
            <section class="border-r-2 pr-10 border-r-orange-500/40" aria-labelledby="first-year">
                <h3 class="text-2xl uppercase font-medium mb-14" id="first-year" aria-level="3" role="heading">{{__('1er Année')}}</h3>
                <p class="text-lg">{{__('Cours du tron commun')}}</p>
                <section class="text-lg mt-8 gap-2" aria-labelledby="web">
                    ...
                    <div class="flex justify-between">
                        <div class="flex flex-col gap-2">
                            ...
                            <a class="hover:text-orange-500 underline" href="/cours/show">{{__('Initialisation à la programmation')}}</a>
                        </div>
                ...
                <section class="text-lg mt-8 flex flex-col gap-2" aria-labelledby="3D">
                ...
                <section class="text-lg mt-8 flex flex-col gap-2" aria-labelledby="graphic-design">
            ...
            <section class="border-r-2 pr-10 border-r-orange-500/40" aria-labelledby="second-year">
                <h3 class="text-2xl uppercase font-medium mb-14" id="second-year" aria-level="3" role="heading">{{__('2e Année')}}</h3>
                <p class="text-lg">{{__('Cours du tron commun')}}</p>
                <section class="text-lg mt-8 gap-2" aria-labelledby="second-web">
                    ...
                    <div class="flex justify-between">
                        <div class="flex flex-col gap-2">
                            ...
                            <a class="underline hover:text-orange-500" href="/cours/show">{{__('Design d\'application mobile')}}</a>
                            <a class="underline hover:text-orange-500" href="/cours/show">{{__('Développement côté serveur')}}</a>
                            <a class="underline hover:text-orange-500" href="/cours/show">{{__('Développement côté client')}}</a>
                            <a class="underline hover:text-orange-500" href="/cours/show">{{__('Multimédia')}}</a>
                            <a class="underline hover:text-orange-500" href="/cours/show">{{__('Système de gestion de base de données')}}</a>
                        </div>
                        <div class="flex flex-col ml-8 gap-2">
                            <p>{{__('165H')}}</p>
                            <p>{{__('30H')}}</p>
            ...
            <section aria-labelledby="third-year">
                <h3 class="text-2xl uppercase font-medium mb-14" id="third-year" aria-level="3" role="heading">{{__('3e Année')}}</h3>
                <p class="text-lg">{{__('Cours du tron commun')}}</p>
                <section class="text-lg mt-8 gap-2" aria-labelledby="third-web">
                    ...
                    <div class="flex justify-between">
                        <div class="flex flex-col gap-2">
                            ...
                            <a class="underline hover:text-orange-500" href="/cours/show">{{__('Développement d\'application mobile')}}</a>
                            <a class="underline hover:text-orange-500" href="/cours/show">{{__('Projet de fin d\'étude')}}</a>
    ...
    <section class="px-36 mt-14 mb-36 gap-24 items-center" aria-labelledby="profs">
        <div class="flex-1 flex mt-36 justify-between">
            ...
            <div class="hover:text-orange-500 flex justify-end text-green-700 underline font-sans text-2xl font-semibold">
                <a href="/bottin/alumni">{{__('Voir le bottin')}}</a>
            </div>
        </div>
        <div class="grid grid-cols-2 mt-36 gap-y-40 gap-x-60">
            @for($i=1; $i<7; $i++)
                <article class=" even:mt-36 relative" aria-labelledby="slug">
                    ...
                    <div class="relative bg-yellow-100 rounded-xl px-4 py-8 left-10">
                        <h3 class="font-medium text-2xl mb-5" id="slug" aria-level="3" role="heading">Nom du professeur</h3>
                        <a class="hover:text-orange-500 text-xl underline text-green-700" href="mailto:@hepl.be">adresse mail</a>
                        <div class="flex gap-48 items-center mt-4 ">
                        ...
                        <p class="text-green-500 text-lg items-end uppercase">professeur</p>
                        </div>
                    </div>
                </article>
            @endfor
    ...
    <article  class="bg-yellow-600 px-36 pb-36 pt-20" aria-labelledby="jobs">
        ...
        <div class="grid grid-cols-2 gap-x-24 gap-y-8">
            <article aria-labelledby="ux" class="bg-white-100 py-6 px-8 rounded-3xl relative">
                <h3 id="ux" aria-level="3" role="heading" class="font-medium text-2xl mb-3 font-medium">{{__('Designer d\'expérience utilisateur (UX Designer)')}}</h3>
            ...
            <article aria-labelledby="dev-back" class="bg-white-100 py-6 px-8 rounded-3xl relative">
                <h3 id="dev-back" aria-level="3" role="heading" class="font-medium text-2xl mb-3 font-medium">{{__('Développeur Web Back-End')}}</h3>
            ...
            <article aria-labelledby="des-mmi" class="bg-white-100 py-6 px-8 rounded-3xl relative">
                <h3 id="des-mmi" aria-level="3" role="heading" class="font-medium text-2xl mb-3 font-medium">{{__('Designer Multimédia')}}</h3>
            ...
            <article aria-labelledby="dev-mmi" class="bg-white-100 py-6 px-8 rounded-3xl relative">
                <h3 id="dev-mmi" aria-level="3" role="heading" class="font-medium text-2xl mb-3 font-medium">{{__('Développeur Multimédia')}}</h3>
            ...
            <article aria-labelledby="ui" class="bg-white-100 py-6 px-8 rounded-3xl relative">
                <h3 id="ui" aria-level="3" role="heading" class="font-medium text-2xl mb-3 font-medium">{{__('Designer d\'interface (UI Designer)')}}</h3>
            ...
            <article aria-labelledby="dev-front" class="bg-white-100 py-6 px-8 rounded-3xl relative">
                <h3 id="dev-front" aria-level="3" role="heading" class="font-medium text-2xl mb-3 font-medium">{{__('Développeur Web Front-End')}}</h3>
            ...
            <article aria-labelledby="des-web" class="bg-white-100 py-6 px-8 rounded-3xl relative">
                <h3 id="des-web" aria-level="3" role="heading" class="font-medium text-2xl mb-3 font-medium">{{__('Designer Web')}}</h3>
            ...
            <article aria-labelledby="dev-web" class="bg-white-100 py-6 px-8 rounded-3xl relative">
                <h3 id="dev-web" aria-level="3" role="heading" class="font-medium text-2xl mb-3 font-medium">{{__('Développeur Web')}}</h3>
            ...
            <article aria-labelledby="des-mobile" class="bg-white-100 py-6 px-8 rounded-3xl relative">
                <h3 id="des-mobile" aria-level="3" role="heading" class="font-medium text-2xl mb-3 font-medium">{{__('Designer Mobile')}}</h3>
            ...
            <article aria-labelledby="dev-mobile" class="bg-white-100 py-6 px-8 rounded-3xl relative">
                <h3 id="dev-mobile" aria-level="3" role="heading" class="font-medium text-2xl mb-3 font-medium">{{__('Développeur Mobile')}}</h3>
