...
<main id="content" class="">
    <section class="mt-20" aria-labelledby="bottin">
        <div class="px-10 2xl:px-48 flex flex-col xl:px-36 xl:flex-row justify-between mb-7 xl:items-center">
        ...
        <p class="px-10 2xl:px-48 xl:pl-36 mb-7 xl:max-w-[47%] xl:text-xl xl:leading-10">{{__('people.bottin_text')}}</p>
        <x-sort_by :status="$status" :years_end="$years_end"/>
        <article class="px-10 2xl:px-48 flex flex-col gap-y-4 xl:px-36 xl:grid xl:grid-cols-2 xl:gap-x-24 xl:gap-y-8"
