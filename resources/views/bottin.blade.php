...
<main id="content">
    <section class="mt-20" aria-labelledby="bottinSection">
        <div class="px-10 lg:px-16 2xl:px-48 flex flex-col xl:px-32 md:flex-row justify-between mb-7 xl:items-center">
        ...
        <x-sort_search.sort_by_people class="mb-14" id="bottin_sort" :urlAction="$urlAction" :status="$status" :years_end="$years_end"/>
