...
<main class="">
    <section class="mt-20">
        <div class="px-36 flex justify-between mb-7 items-center">
            <h2 class="text-4xl uppercase font-extrabold text-yellow-800 font-sans text-center">{{__('Bottin')}}</h2>
        ...
        <article class="px-36 grid grid-cols-2 gap-x-24 gap-y-8">
            <h3 class="sr-only">{{__('Liste du bottin')}}</h3>
            @for($i=1; $i<3;$i++)
