                ...
                @auth()
                    ...
                    @else
                        @foreach($comments as $comment)
                            <article class="slide-in flex flex-col bg-yellow-100 py-3 px-4 xl:py-6 xl:px-10 rounded-xl" aria-labelledby="{{$comment->slug}}">
                                ...
                                <div class="flex -order-1 items-center ">
                                    ...
                                    <picture>
                                        ...
                                        @endif
                                        <img
                                            src="{{$comment->user->avatars && $comment->user->avatars['tiny'] ? '/' . $comment->user->avatars['tiny'] : '/'.$comment->user->avatar}}"
