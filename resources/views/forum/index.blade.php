    ...
    <section class="mt-20" aria-labelledby="forum">
        ...
        <div class="grid grid-cols-5 gap-24 mb-36">
            <div class="col-span-3 flex flex-col gap-y-8 pr-14 px-36 ">
                @for($i=1;$i<8;$i++)
                    <article class="bg-yellow-100 flex p-6 rounded-xl" aria-labelledby="questions">
                        <div class="order-2 flex-1 flex flex-col ml-4">
                            <h3 id="questions" aria-level="2" role="heading" class="order-2 font-medium font-sans text-2xl mb-4">Question du forum</h3>
