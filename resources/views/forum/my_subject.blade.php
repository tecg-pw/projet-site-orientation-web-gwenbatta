...
<main id="content">
    ...
    <section class="mt-20" aria-labelledby="forum">
        ...
        <div class="flex items-start md:flex-row flex-col xl:gap-32 mb-12 2xl:px-48 px-10 xl:px-32 lg:px-16">
            <a class="xl:text-xl text-lg text-center underline text-green-700 font-semibold  font-sans hover:text-orange-500  px-5 py-2"
            ...
            <a class="xl:text-xl text-lg text-center hover:text-orange-500 underline text-green-700 font-semibold rounded-lg font-sans bg-orange-100 px-5 py-2"
            ...
            <div class="col-span-3 flex flex-col gap-y-8 xl:pr-14 lg:pr-7 2xl:px-48 px-10 xl:px-32 lg:px-16 ">
                @if(count($subjects)===0)
                    ...
                    @foreach($subjects as $subject)
                        <article
                            class="group hover:bg-orange-100 bg-yellow-100 relative flex p-6 lg:px-3 xl:px-6 rounded-xl"
