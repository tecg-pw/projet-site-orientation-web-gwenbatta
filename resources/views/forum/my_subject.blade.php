...
<main id="content">
    ...
    <section class="mt-20" aria-labelledby="forum">
        ...
        <x-sort_search.sort_by_forum id="sortmysubject" :urlAction="$urlAction" :status="$status" :tags="$tags" :created="$created" class="px-10 2xl:px-48 xl:px-32 lg:px-16 mb-14"></x-sort_search.sort_by_forum>
